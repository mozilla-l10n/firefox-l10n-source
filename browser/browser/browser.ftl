...
firefox-relay-offer-how-we-integrate = By continuing, you’ll be able generate new { -relay-brand-short-name } email masks directly from your { -brand-shorter-name } password manager.
