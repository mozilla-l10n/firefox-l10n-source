...
newtab-privacy-message-informed-1 = Trackers watch what you do across sites. <a data-l10n-name="link">{ -brand-short-name } blocks</a> many of them automatically.
newtab-privacy-message-informed-2 = <a data-l10n-name="link">Blocking trackers</a> helps stop companies from following you around online.
newtab-privacy-message-informed-3 = <a data-l10n-name="link">Many sites have trackers</a> so companies you’ve never visited may follow you online.
newtab-privacy-message-informed-4 = Choosing { -brand-short-name } means <a data-l10n-name="link">choosing more protection by default</a>.
newtab-privacy-message-informed-5 = Blocked trackers means fewer companies can follow you across sites.
newtab-privacy-message-informed-6 = We never sell your data, but other browsers might.
newtab-privacy-message-informed-7 = Check here to learn more about { -brand-short-name } privacy.
newtab-privacy-message-informed-8 = Check here for bite-size ways { -brand-short-name } helps protect your privacy.
# Variables:
#   $count (number) - Number of trackers blocked
newtab-privacy-message-informed-9 =
    { $count ->
        [one] { -brand-short-name } blocked { $count } tracker that was draining your device’s power.
       *[other] { -brand-short-name } blocked { $count } trackers that were draining your device’s power.
    }
...
# Variables:
#   $website (string) - A website / domain name
newtab-privacy-message-informed-10 = The <a data-l10n-name="link">top trackers we blocked</a> for you this week were from { $website }.
newtab-privacy-message-informed-11 = Limited data plan? { -brand-short-name }’s tracker blocking can help save bandwidth and prevent overages.
newtab-privacy-message-informed-12 = When <a data-l10n-name="link">{ -brand-short-name } blocks trackers</a>, that means more bandwidth for smoother music and video streaming.
...
newtab-privacy-message-boost-1 = Save your passwords in { -brand-short-name } so it’s easier to use strong, unique logins everywhere.
newtab-privacy-message-boost-2 = <a data-l10n-name="link">Get alerts in { -monitor-brand-short-name }</a> to know if your email shows up in a data breach.
newtab-privacy-message-boost-3 = Protect your personal info with <a data-l10n-name="link">free data breach monitoring</a>, for up to 20 email addresses.
newtab-privacy-message-boost-4 = <a data-l10n-name="link">Sign in to { -brand-short-name }</a> to keep your bookmarks, passwords, and tabs encrypted across devices.
newtab-privacy-message-boost-5 = Shopping on public Wi-Fi? <a data-l10n-name="link">Using a VPN</a> can add another layer of protection.
newtab-privacy-message-boost-6 = Using airport Wi-Fi? Protect your browsing by <a data-l10n-name="link">turning on the built-in VPN</a>.
newtab-privacy-message-boost-7 = <a data-l10n-name="link">Turn on the built-in VPN</a> to add extra protection and keep your location more private.
newtab-privacy-message-boost-8 = Try a private window to browse more when using a shared computer.
newtab-privacy-message-boost-9 = Save your real email address for people you trust; <a data-l10n-name="link">use an email mask</a> for sign-ups.
newtab-privacy-message-boost-10 = <a data-l10n-name="link">Use an email mask</a> to protect your real address from spam in your inbox.
newtab-privacy-message-boost-11 = Get <a data-l10n-name="link">50 free email masks in { -brand-short-name }</a>. Use one for every account to keep your real email private.

## Privacy widget messages: Feel protected
## Rotating messages shown in the Privacy widget (feature highlight: "Feel protected").

newtab-privacy-message-feel-1 = Keep browsing, { -brand-short-name } will keep blocking.
newtab-privacy-message-feel-2 = { -brand-short-name } is backed by { -vendor-short-name }, a non-profit focused on building a better web.
newtab-privacy-message-feel-3 = { -vendor-short-name } built { -brand-short-name } to put people and privacy first on the web.
...
newtab-privacy-message-celebrate-1 =
    { $count ->
        [one] You <a data-l10n-name="link">blocked { $count } tracker</a> this week. Nice work keeping your browsing more private.
       *[other] You <a data-l10n-name="link">blocked { $count } trackers</a> this week. Nice work keeping your browsing more private.
    }
# Variables:
#   $count (number) - Number of trackers blocked this month
newtab-privacy-message-celebrate-2 =
    { $count ->
        [one] <a data-l10n-name="link">{ $count } tracker blocked</a> this month. A big step to keeping companies from following you online.
       *[other] <a data-l10n-name="link">{ $count } trackers blocked</a> this month. A big step to keeping companies from following you online.
    }
# Variables:
#   $count (number) - Number of trackers blocked this year
newtab-privacy-message-celebrate-3 =
    { $count ->
        [one] You’ve <a data-l10n-name="link">blocked { $count } tracker</a> this year. That’s a powerful year of protecting your privacy.
       *[other] You’ve <a data-l10n-name="link">blocked { $count } trackers</a> this year. That’s a powerful year of protecting your privacy.
    }
# "in your den" refers to keeping things private — it's a play on words
# referring to a fox's home, called a "den" in English
newtab-privacy-message-celebrate-4 = With { -brand-short-name }, you’re helping to keep more of what you do online in your den.
newtab-privacy-message-celebrate-5 = You’re on a roll — fewer trackers means more privacy.
newtab-privacy-message-celebrate-6 = You’ve blocked <a data-l10n-name="link">1,000 trackers</a>. That’s major progress towards privacy on your terms.
# Variables:
#   $count (number) - Number of consecutive days protected. Only fires at 3, 5,
#                     or 7 days.
newtab-privacy-message-celebrate-days =
    { $count ->
       *[other] <a data-l10n-name="link">You’ve been protected</a> { $count } days in a row.
    }
